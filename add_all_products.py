...
electronics_products = [
    ...
    ("PROD-ELEC-001", "Mobile Phone", "Electronics", 599.99, 
     ...
     50, 4.8, "6.7 inch Display,5G Connectivity,12MP Camera,4500mAh Battery,Waterproof Design,256GB Storage"),
    ...
    ("PROD-ELEC-002", "Laptop", "Electronics", 1299.99, 
     ...
     30, 4.9, "Intel i7 Processor,16GB RAM,512GB SSD,14 inch Display,8 Hour Battery,Aluminum Body"),
    ...
    ("PROD-ELEC-003", "Camera", "Electronics", 899.99, 
     ...
     25, 4.7, "24MP Sensor,4K Video,Wi-Fi & Bluetooth,Dual SD Card Slots,Weather Sealed,3 inch Touchscreen"),
    
    # Audio Headphones
    ("PROD-ELEC-004", "Audio Headphones", "Electronics", 349.99, 
     "Premium noise-cancelling wireless headphones", 
     "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop", 
     60, 4.8, "Active Noise Cancellation,40 Hour Battery,Bluetooth 5.0,Premium Sound Quality,Comfortable Design,Built-in Microphone"),
    
    # Smart Watch
    ("PROD-ELEC-005", "Smart Watch", "Electronics", 199.99, 
     "Feature-rich smartwatch for daily wear", 
     "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop", 
     80, 4.6, "Heart Rate Monitor,GPS Tracking,5 Day Battery,Water Resistant,Multiple Sports Modes,Sleep Tracking"),
    
    # Portable Speaker
    ("PROD-ELEC-006", "Portable Speaker", "Electronics", 179.99, 
     "Powerful portable Bluetooth speaker", 
     "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop", 
     70, 4.7, "360 Degree Sound,24 Hour Battery,Waterproof Design,Bluetooth 5.0,Built-in Microphone,Compact Design"),
    ...
    ("PROD-ELEC-007", "Mechanical Keyboard", "Electronics", 149.99, 
     ...
     45, 4.8, "RGB Backlight,Mechanical Switches,Programmable Keys,Wireless Connected,Ergonomic Design,USB Type-C"),
    ...
    ("PROD-ELEC-008", "Gaming Mouse", "Electronics", 79.99, 
     ...
     100, 4.5, "16000 DPI Sensor,Customizable Buttons,Wireless Connection,Long Battery Life,Ergonomic Shape,RGB Lighting"),
]
...
books_products = [
    ...
    ("PROD-BOOK-001", "The Great Novel", "Books", 24.99, 
     ...
     100, 4.8, "Hardcover,450 Pages,Award Winner,Bestseller,Fiction,Award Winning"),
    ...
    ("PROD-BOOK-002", "Python Programming", "Books", 34.99, 
     ...
     75, 4.9, "Technical,600 Pages,Code Examples,Beginner Friendly,Complete Guide,Latest Version"),
    ...
    ("PROD-BOOK-003", "Science Explained", "Books", 28.99, 
     ...
     80, 4.7, "Educational,380 Pages,Illustrations,Fun Facts,Science,Interactive"),
    ...
    ("PROD-BOOK-004", "Business Success", "Books", 32.99, 
     ...
     60, 4.8, "Business,520 Pages,Case Studies,Practical Tips,Success Stories,Real Examples"),
    ...
    ("PROD-BOOK-005", "Mystery Thriller", "Books", 26.99, 
     ...
     90, 4.6, "Thriller,400 Pages,Page Turner,Suspenseful,Mystery,Plot Twist"),
    ...
    ("PROD-BOOK-006", "World History", "Books", 30.99, 
     ...
     70, 4.7, "History,550 Pages,Maps,Timeline,Historical,Detailed"),
    
    # Self Help Guide
    ("PROD-BOOK-007", "Self Help Guide", "Books", 22.99, 
     "Transform your life with proven techniques", 
     "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=400&h=400&fit=crop", 
     120, 4.5, "Self Help,320 Pages,Exercises,Motivational,Practical,Life Changing"),
    ...
    ("PROD-BOOK-008", "Fantasy Adventure", "Books", 27.99, 
     ...
     85, 4.8, "Fantasy,480 Pages,Epic Journey,Magic,Adventure,Series"),
]
...
grocery_products = [
    ...
    ("PROD-GROC-001", "Fresh Potatoes (1kg)", "Grocery", 3.99, 
     ...
     500, 4.7, "Fresh Harvest,Rich in Potassium,Good for Curries,Long Shelf Life,High Quality,Farm Fresh"),
    ...
    ("PROD-GROC-002", "Fresh Apples (1kg)", "Grocery", 4.99, 
     ...
     300, 4.8, "Organic,Fresh Picked,Rich in Fiber,High Vitamin C,No Pesticides,Long Shelf Life"),
    ...
    ("PROD-GROC-003", "Organic Carrots (500g)", "Grocery", 2.99, 
     ...
     400, 4.6, "100% Organic,Fresh Quality,Rich Taste,High Beta-Carotene,Farm Fresh,No Chemicals"),
    ...
    ("PROD-GROC-004", "Fresh Broccoli (1 head)", "Grocery", 3.49, 
     ...
     350, 4.7, "Nutrient Dense,Fresh Picked,Rich in Vitamins,High Fiber,Perfect for Cooking,Long Lasting"),
    ...
    ("PROD-GROC-005", "Fresh Tomatoes (1kg)", "Grocery", 3.99, 
     ...
     400, 4.8, "100% Organic,Farm Fresh,Rich Red Color,Perfect Ripeness,No Pesticides,Great Flavor"),
    ...
    ("PROD-GROC-006", "Fresh Bananas (1 bunch)", "Grocery", 2.49, 
     ...
     600, 4.9, "Rich in Potassium,Sweet Taste,High Energy,Natural Sugars,Perfect Yellow,Best Bunch"),
    ...
    ("PROD-GROC-007", "Fresh Onions (1kg)", "Grocery", 2.99, 
     ...
     500, 4.5, "Fresh Harvest,Strong Flavor,Good for Cooking,Long Shelf Life,High Quality,Farm Fresh"),
    ...
    ("PROD-GROC-008", "Fresh Spinach (250g)", "Grocery", 3.29, 
     ...
     300, 4.7, "High Iron,Antioxidants,Dark Green Color,Organic Grown,Tender Leaves,Perfect for Cooking"),
]
...
fashion_products = [
    ...
    ("PROD-FASH-001", "Men's Formal Shirt", "Fashion", 49.99, 
     ...
     200, 4.7, "100% Cotton,Easy Care,Multiple Sizes,Regular Fit,Wrinkle-Free,Machine Washable"),
    ...
    ("PROD-FASH-002", "Women's Dress", "Fashion", 79.99, 
     ...
     150, 4.8, "Comfortable Fit,Beautiful Design,Multiple Colors,Party Ready,Breathable Fabric,Hand Washable"),
    ...
    ("PROD-FASH-003", "Denim Jeans", "Fashion", 69.99, 
     ...
     300, 4.6, "Premium Denim,Comfortable,All Sizes,Fade Resistant,Durable,Deep Blue Color"),
    
    # Casual T-Shirt
    ("PROD-FASH-004", "Casual T-Shirt", "Fashion", 24.99, 
     "Comfortable casual t-shirt for daily wear", 
     "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop", 
     400, 4.5, "Soft Fabric,Breathable,Multiple Colors,Easy Wash,Great Fit,All Sizes"),
    ...
    ("PROD-FASH-005", "Hoodie Sweatshirt", "Fashion", 54.99, 
     ...
     180, 4.8, "Plush Fabric,Drawstring Hood,Kangaroo Pocket,Easy Maintenance,Durable, Various Colors"),
    ...
    ("PROD-FASH-006", "Women's Shoes", "Fashion", 89.99, 
     ...
     120, 4.7, "Premium Quality,Comfortable,Non-Slip Sole,Elegant Design,Breathable,All Sizes"),
    
    # Handbag
    ("PROD-FASH-007", "Handbag", "Fashion", 129.99, 
     "Premium handbag with elegant design", 
     "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop", 
     80, 4.9, "Genuine Material,Spacious,Strong Handles,Multiple Pockets,Fashionable,Durable"),
    ...
    ("PROD-FASH-008", "Winter Scarf", "Fashion", 34.99, 
     ...
     250, 4.4, "Soft Wool,Warm Material,Fashion Forward,All Ages,Easy Care,Multiple Colors"),
]
